...
function TagWithTooltip({
  label, color, selected, onClick, promptContribution,
}: {
        ...
        <div style={{ borderRight: "1px solid var(--border)", display: "flex", flexDirection: "column" }}>
          <div style={{ flex: 1, overflowY: "auto", padding: "20px 24px", display: "flex", flexDirection: "column", gap: 20 }}>
                  ...
                  <Tooltip key={uc.id} data={USE_CASE_TOOLTIPS[uc.id] || { short: uc.description }}>
                    <button
                      ...
                      style={{
                        ...
                        border: `1px solid ${useCase === uc.id ? "var(--accent)" : "var(--border)"}`,
                        borderRadius: 7,
                        background: useCase === uc.id ? "rgba(255,77,0,0.1)" : "var(--surface)",
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              {/* Tone */}
              <div>
                <div style={{ fontSize: 9, letterSpacing: 2.5, textTransform: "uppercase", color: "var(--text-dim)", marginBottom: 7, fontFamily: "var(--font-mono)" }}>Stil-Tonalität</div>
                <div style={{ position: "relative" }}>
                  <select value={tone} onChange={e => setTone(e.target.value)} style={{ width: "100%", appearance: "none", background: "var(--surface)", border: "1px solid var(--border2)", borderRadius: 6, color: "#c8c4be", fontSize: 11, padding: "9px 28px 9px 12px", cursor: "pointer" }}>
              ...
              {mode === "video" && (
                <div>
                  <div style={{ fontSize: 9, letterSpacing: 2.5, textTransform: "uppercase", color: "var(--text-dim)", marginBottom: 7, fontFamily: "var(--font-mono)" }}>Videolänge</div>
                  <div style={{ position: "relative" }}>
                    <select value={duration} onChange={e => setDuration(e.target.value)} style={{ width: "100%", appearance: "none", background: "var(--surface)", border: "1px solid var(--border2)", borderRadius: 6, color: "#c8c4be", fontSize: 11, padding: "9px 28px 9px 12px", cursor: "pointer" }}>
